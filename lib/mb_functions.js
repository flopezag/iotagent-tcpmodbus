...
mb_fnc['05'] = function (mb_fnc_code, mb_req_pdu) {
    ...
    let [address, value] = extract_data(mb_req_pdu);
...
mb_fnc['06'] = function (mb_fnc_code, mb_req_pdu) {
    /************************************
...
mb_fnc['0F'] = function (mb_fnc_code, mb_req_pdu) {
    /************************************
     * Write Single Holding Register
     ************************************/
    let [address, quantity, byteCount, values] = extract_multiple_data(mb_req_pdu);
